...
#user module
    ...
    re_path(r'^delete/(?P<id>\d+)$', views.platform_delete,name="delete"),
    re_path(r'^platformedit$', views.platformedit,name="platformedit"),
    re_path(r'^platform_edit/$', views.platform_edit,name="platform_edit"),
